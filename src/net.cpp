...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Drugocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"drugocointools.com", "dnsseed.drugocointools.com"},
    {"drugocoinpool.org", "dnsseed.drugocoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"drugocointools.com", "testnet-seed.drugocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Drugocoin is probably already running."), addrBind.ToString().c_str());
        else
